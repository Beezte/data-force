...
# Conectar ao banco de dados de gráfico Neo4j
...
# Extraindo dados da tabela UsoServico
...
for (usuario_id, frequencia_uso, generos_favoritos, dispositivos_usados, metricas_engajamento) in cursor:
    # Crie um nó de uso de serviço e um relacionamento com o nó de usuário correspondente
...
for (suporte_id, usuario_id, interacoes_suporte) in cursor:
    # Crie um nó de suporte ao cliente e um relacionamento com o nó de usuário correspondente
